  ...
  (() => {
    var e, t, o, r, c, h, m, f, p, j, x, E, F, T, z, n = Object.assign || function(e2) {
      for (var t2, s2, n2 = 1; n2 < arguments.length; n2++) {
        t2 = arguments[n2];
        for (s2 in t2) Object.prototype.hasOwnProperty.call(t2, s2) && (e2[s2] = t2[s2]);
      }
      return e2;
    }, i = function(t2) {
...
See: https://github.com/francoischalifour/medium-zoom`);
      ...
      var r2, u2, y2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, p2 = window.Promise || function(t3) {
        ...
        if (c2.indexOf(n2) === -1) return;
        v2({ target: n2 });
      }, A2 = function() {
        if (d2 || !o2.original) return;
        ...
        for (var n2, s2 = arguments.length, o3 = Array(s2), t3 = 0; t3 < s2; t3++) o3[t3] = arguments[t3];
        ...
        for (var i3, a2 = arguments.length, n2 = Array(a2), t3 = 0; t3 < a2; t3++) n2[t3] = arguments[t3];
        ...
        var f3 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, t3 = f3.target, h3 = function() {
          if (t4 = { width: document.documentElement.clientWidth, height: document.documentElement.clientHeight, left: 0, top: 0, right: 0, bottom: 0 }, s2 = void 0, r3 = void 0, i2.container) if (i2.container instanceof Object) t4 = n({}, t4, i2.container), s2 = t4.width - t4.left - t4.right - i2.margin * 2, r3 = t4.height - t4.top - t4.bottom - i2.margin * 2;
          else {
        ...
        return new p2(function(e2) {
          ...
          if (t3) o2.original = t3;
          else if (c2.length > 0) f4 = c2, o2.original = f4[0];
          else {
            e2(r2);
            return;
          }
    ...
    function N(e2, t2) {
      ...
      if (!e2 || typeof document == "undefined") return;
    ...
    function K() {
      if (!u()) return console.debug("User theming disabled."), { isDarkTheme: window.wc.isSiteThemeDark, themeMode: window.wc.isSiteThemeDark ? 1 : 0 };
    ...
    function b(t2, n2 = 2, s2 = false) {
      ...
      if (document.dispatchEvent(c2), !s2 && (t2 === false && !e.classList.contains("dark") || t2 === true && e.classList.contains("dark"))) return;
    ...
    function g(e2, t2 = 0) {
      ...
      } else console.debug("Cannot scroll to target `#" + e2 + "`. ID not found!");
    }
    function S() {
    ...
    $(document).ready(function() {
      ...
      $(".pub-filters-select") && P(), $(".js-cite-modal").click(function(e3) {
        ...
        n3.find(".modal-body code").load(t3, function(e4, n4, s3) {
          ...
          } else $(".js-download-cite").attr("href", t3);
        }), n3.modal("show");
    ...
    function s(e2, t2) {
      ...
      if (s2.length < 1 && ($("#search-hits").empty(), $("#search-common-queries").show()), !e2 && s2.length < n.minMatchCharLength) return;
    ...
    function d(e2, t2) {
      let n2, s2, o2;
      for (n2 in t2) s2 = "\\{\\{\\s*" + n2 + "\\s*\\}\\}", o2 = new RegExp(s2, "g"), e2 = e2.replace(o2, t2[n2]);
      return e2;
    }
